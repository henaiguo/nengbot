...
#define SYN_ENTER_RETURN(mutex, synobj, ret) \
	common_library::thread::Synchronizer synobj(common_library::thread::Synchronizer::eSYN_MUTEX, mutex, NULL); \
	if (!synobj.Enter()) { \
		return ret; \
	}
...
#define SYN_READ_ENTER(rwlock, synobj) \
	common_library::thread::Synchronizer synobj(common_library::thread::Synchronizer::eSYN_RWLOCK, NULL, rwlock); \
	if (!synobj.ReadEnter()) { \
		return; \
	}
...
public:
    ...
    /// @note
    ///////////////////////////////////////////////////////////
    Synchronizer(eSynchronizeType _type, Mutex& _mutex, RWLock& _rwlock);
